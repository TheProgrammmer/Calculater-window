...
function pull_value() {
	if(page == 'tree') {
		let checkbox1 = "Без противавзломной фурнитуры";
		let checkbox2 = "Без аллюминовый оклады";
		let checkbox3 = "Без энергосберегающий стеклопакета";
		if($('.checkbox').eq(0).attr('class') == 'checkbox arrow-img'){
			checkbox1 = "С противавзломной фурнитурой";
		}
		if($('.checkbox').eq(1).attr('class') == 'checkbox arrow-img'){
			checkbox2 = "С аллюминовой окладой";
		}
